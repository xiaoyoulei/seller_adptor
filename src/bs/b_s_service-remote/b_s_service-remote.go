...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  void search2()")
...
func main() {
	...
	client := bs.NewBSServiceClientFactory(trans, protocolFactory)
	...
	case "search2":
		if flag.NArg()-1 != 0 {
			fmt.Fprintln(os.Stderr, "Search2 requires 0 args")
			flag.Usage()
		}
		fmt.Print(client.Search2())
		fmt.Print("\n")
		break
	case "search":
		if flag.NArg()-1 != 1 {
