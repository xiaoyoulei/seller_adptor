...
func (this *PrePackModule) Init(golbal_conf *context.GlobalContext) (err error) {
	this.click_head = golbal_conf.Prepack.ClickHeader
	this.win_head = golbal_conf.Prepack.WinHeader
